      ...
      <div className="wrap">
        ...
        <section id="certs">
          ...
          <div className="certs-grid">
            ...
            <div className="cc ip"><div className="cc-left"><div className="cc-icon">🔍</div><div><div className="cc-name">Intro to Digital Forensics</div><div className="cc-meta"><span className="cc-issuer">Alison</span></div></div></div><span className="cc-status st-ip">In Progress</span></div>
