      ...
      <div className="wrap">
        ...
        <section id="certs">
          ...
          <div className="certs-grid">
            ...
            <a className="cc cc-parent" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">🛡️</div><div><div className="cc-name">Blue Team Junior Analyst (BTL1)</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div><div className="cc-name">Intro to Digital Forensics</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div><div className="cc-name">Intro to OSINT</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div><div className="cc-name">Intro to Network Analysis</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div><div className="cc-name">Intro to Dark Web Operations</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div><div className="cc-name">Intro to Vulnerability Management</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div><div className="cc-name">Intro to Threat Hunting</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
