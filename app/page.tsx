...
.cc-sub{margin-left:2rem;border-left:2px solid var(--border)}
.cc-sub .cc-left{padding-left:.5rem}
      ...
      <div className="wrap">
        ...
        <section id="certs">
          ...
          <div className="certs-grid">
            ...
            <a className="cc" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">🎓</div><div><div className="cc-name">Cyber Forensics Intro</div><div className="cc-meta"><span className="cc-issuer">Great Learning</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            ...
            <a className="cc" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">🛡️</div><div><div className="cc-name">Blue Team Junior Analyst (BTL1)</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">└</div><div><div className="cc-name">Intro to Digital Forensics</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">└</div><div><div className="cc-name">Intro to OSINT</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">└</div><div><div className="cc-name">Intro to Network Analysis</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">└</div><div><div className="cc-name">Intro to Dark Web Operations</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">└</div><div><div className="cc-name">Intro to Vulnerability Management</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <a className="cc cc-sub" href="#" title="View certificate"><div className="cc-left"><div className="cc-icon">└</div><div><div className="cc-name">Intro to Threat Hunting</div><div className="cc-meta"><span className="cc-issuer">Security Blue Team</span></div></div></div><span className="cc-status st-e">Earned</span></a>
            <div className="cg-label">// In Progress</div>
            <div className="cc ip"><div className="cc-left"><div className="cc-icon">📜</div><div><div className="cc-name">California Paralegal Certificate</div><div className="cc-meta"><span className="cc-issuer">Cal State LA</span></div></div></div><span className="cc-status st-ip">In Progress</span></div>
            <div className="cg-label">// Planned</div>
            <div className="cc"><div className="cc-left"><div className="cc-icon">🛡️</div><div><div className="cc-name">NSE 1 — Network Security Associate</div><div className="cc-meta"><span className="cc-issuer">Fortinet</span></div></div></div><span className="cc-status st-p">Planned</span></div>
            <div className="cc"><div className="cc-left"><div className="cc-icon">🛡️</div><div><div className="cc-name">NSE 2 — Network Security Associate</div><div className="cc-meta"><span className="cc-issuer">Fortinet</span></div></div></div><span className="cc-status st-p">Planned</span></div>
            <div className="cc"><div className="cc-left"><div className="cc-icon">🛡️</div><div><div className="cc-name">NSE 3 — Network Security Associate</div><div className="cc-meta"><span className="cc-issuer">Fortinet</span></div></div></div><span className="cc-status st-p">Planned</span></div>
            <div className="cc"><div className="cc-left"><div className="cc-icon">🔍</div><div><div className="cc-name">ACI — AccessData Certified Investigator</div><div className="cc-meta"><span className="cc-issuer">Exterro / AccessData</span></div></div></div><span className="cc-status st-p">Planned</span></div>
            <div className="cc"><div className="cc-left"><div className="cc-icon">📁</div><div><div className="cc-name">DFE — Digital Forensics Essentials</div><div className="cc-meta"><span className="cc-issuer">EC-Council</span></div></div></div><span className="cc-status st-p">Planned</span></div>
            <div className="cc"><div className="cc-left"><div className="cc-icon">🔬</div><div><div className="cc-name">CHFI — Computer Hacking Forensic Investigator</div><div className="cc-meta"><span className="cc-issuer">EC-Council</span></div></div></div><span className="cc-status st-p">Planned</span></div>
          </div>
        </section>
